 ...
 */
export const AdminMenu = ({ span, offset }) => {
    ...
    return (
        <Row>
            <Col xs={{ span: span, offset: offset }}>
                <div className={"image-container"} style={((pb.authStore.model && pb.authStore.model.role && pb.authStore.model.role != "Member") ? ninths : single)} >
